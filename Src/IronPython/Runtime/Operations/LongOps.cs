        ...
        public static string/*!*/ __format__(CodeContext/*!*/ context, BigInteger/*!*/ self, [NotNull]string/*!*/ formatSpec) {
            ...
            switch (spec.Type) {
                ...
                case '%':
                    ...
                    if (spec.ThousandsComma) {
                        digits = val.ToString("#,0." + new string('0', percentPrecision) + "%", CultureInfo.InvariantCulture);
                    } else {
                        digits = val.ToString("0." + new string('0', percentPrecision) + "%", CultureInfo.InvariantCulture);
                    }
                    break;
                case 'e':
                    ...
                    if (spec.ThousandsComma) {
                        digits = val.ToString("#,0." + new string('0', lowerExponentPrecision) + "e+00", CultureInfo.InvariantCulture);
                    } else {
                        digits = val.ToString("0." + new string('0', lowerExponentPrecision) + "e+00", CultureInfo.InvariantCulture);
                    }
                    break;
                case 'E':
                    ...
                    if (spec.ThousandsComma) {
                        digits = val.ToString("#,0." + new string('0', upperExponentPrecision) + "E+00", CultureInfo.InvariantCulture);
                    } else {
                        digits = val.ToString("0." + new string('0', upperExponentPrecision) + "E+00", CultureInfo.InvariantCulture);
                    }
                    break;
